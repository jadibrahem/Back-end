...
ALLOWED_HOSTS = ['halotrust.pythonanywhere.com','127.0.0.1', 'localhost']
...
#     'http://localhost:3000',  # Default React development server address
# ]
...
LOGGING = {
    ...
    'loggers': {
        ...
        'finance': {  # Replace 'myapp' with the name of your Django app
            'handlers': ['console', 'file'],
            'level': 'INFO',
            'propagate': False,
        },
