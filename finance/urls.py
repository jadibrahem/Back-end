...
from finance.views import LoginView , current_user , document_reference , ItemListView , ApprovalLogsView , list_quotation_requests, quotation_request_details ,dashboard_data
urlpatterns = [
    ...
    path('purchase-requests/<int:request_id>/', views.purchase_request_details, name='purchase_request_details'),
